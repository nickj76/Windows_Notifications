...
.SYNOPSIS
The purpose of the script is to create simple Toast Notifications in Windows 10 / 11
...
If ($XMLValid -eq $True) {
    ...
    If (([System.Security.Principal.WindowsIdentity]::GetCurrent()).Name -eq "NT AUTHORITY\SYSTEM") {
        ...
        $Task_TimeToRun = (Get-Date).AddSeconds(60).ToString('s')
        $Task_Expiry = (Get-Date).AddSeconds(300).ToString('s')
        If ($Snooze) {
