...
$EventText = "People Survey is now live - if you haven't completed it yet, don't forget to!"
$EventText2 = "People Survey 2023 You still have time to make your voice count!"
$EventText3 = "If you haven't already completed the 2023 People Survey, you will receive your personal link from People Insight again. Once we hit 70% completion, we will double the number of trees planted for the rest of the survey and if we hit 80%, will double the total number of trees we planted."
...
New-Item -ItemType "file" -Path "c:\logfiles\People_Survey_2023_02_03.txt"