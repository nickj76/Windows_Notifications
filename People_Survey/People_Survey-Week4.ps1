...
$EventText = "People Survey closes on Friday 6th October at 6pm - don't forget to take 10 minutes  to complete it!"
$EventText2 = "People Survey 2023 Make your voice count"
$EventText3 = "This is the final week of the People Survey. Our response rate is approx. xxxx. If we can get it to 80% we will double the total number of trees we donate."
...
New-Item -ItemType "file" -Path "c:\logfiles\People_Survey_2023_04.txt"