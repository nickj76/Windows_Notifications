...
param(
    ...
    [string]$Config = "C:\temp\custom-message.xml"
)
...
# Test if the script is being run on a supported version of Windows. Windows 10 or 11 OS is required.
...
# Default is executing directory. In this case, the custom-message.xml must exist in same directory as the Toast-1.0.ps1 file.
if (-NOT($Config)) {
