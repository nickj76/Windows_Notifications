...
$EventTitle = "Welcome to you new PC"
$EventText = "You're PC will be ready soon. In the meantime, click below to see the apps available to you."
$ButtonTitle = "Browse Apps"
$ButtonAction = "CompanyPortal:"
