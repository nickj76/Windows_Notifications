...
$EventText2 = "For more information about this required upgrade please visit the IT Services FAQs on SurreyNet."
...
New-Item -ItemType "file" -Path "c:\logfiles\Office-Upgrade-090622.txt"