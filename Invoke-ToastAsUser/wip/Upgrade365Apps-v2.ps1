...
param (
    ...
    [String]
    $HeaderText = 'Upgrade to Microsoft 365 Apps.(Package)',
    [Parameter(Mandatory = $false)]
    [String]
    $TitleText = 'Required Upgrade to Microsoft 365 Apps.',
    [Parameter(Mandatory = $false)]
    [String]
    $BodyText1 = "Your device needs to be upgraded to Microsoft 365 Apps, this will take around 30 minutes to complete. You can start the upgrade by clicking on the 'Upgrade Now' button.",
    [Parameter(Mandatory = $false)]
    [String]
