...
param (
    ...
    [String]
    $HeaderText = 'Upgrade to Microsoft 365 Apps.',
    [Parameter(Mandatory = $false)]
    [String]
    $TitleText = 'Required Upgrade to Microsoft 365 Apps.',
    [Parameter(Mandatory = $false)]
    [String]
    $BodyText1 = "The version of MS Office on your managed device needs to be upgraded, this will take around 30 minutes to complete. You can start the upgrade by clicking on the 'Upgrade Now' button below.",
    [Parameter(Mandatory = $false)]
    [String]
    $BodyText2 = "For more information about this required upgrade please visit the IT FAQs on SurreyNet.",
    [Parameter(Mandatory = $false)]
    [String]
    $BodyText3 = "This required upgrade will be automatically installed from: 5th April 2022",
...
$BodyText3 = $Config.BodyText3 #"Messages
$DismissButtonContent = $Config.DismissButtonContent #'Dismiss' #'Acknowledged'
$Buttontitle = $Config.Buttontitle #'Upgrade Now'
$ButtonAction = $Config.ButtonAction #'companyportal:ApplicationId=968d5252-dce4-4629-a885-481914e72c9a'
...
$Configs = [PSCustomObject]@{
    ...
    AttributionText = "Sent by IT Service Desk: $AlertTime"
    TitleText = "$TitleText";
    BodyText1 = "$BodyText1";
    BodyText2 = "$BodyText2";
    BodyText3 = "$BodyText3";
